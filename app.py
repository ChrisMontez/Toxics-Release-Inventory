                ...
                html.Div(
                    ...
                    children=[
                        ...
                        html.P(
                            ...
                            The resulting Choropleth map will display related data from each industrial facility emitting the specified substance. Zoom in and interact with the map to learn more about each facility."""
                        ),
